...
(function() {
  ...
  APIClient = (function(superClass) {
    ...
    APIClient.prototype.codesUpload = function(options, cb) {
      var endpoint, headers, needle, parseResponseBind;
      ...
      endpoint = this.url() + "projects/" + this.options.project_id + "/codes";
      return needle.post(endpoint, options, headers, function(error, response, body) {
        return parseResponseBind(error, response, body, cb, false);
      });
    };
    ...
    APIClient.prototype.tasksRetry = function(id, delay, cb) {
      var parseResponseBind;
      parseResponseBind = _.bind(this.parseResponse, this);
      return this.post("projects/" + this.options.project_id + "/tasks/" + id + "/retry", {
        'delay': delay
      }, function(error, response, body) {
        return parseResponseBind(error, response, body, cb);
      });
    ...
    APIClient.prototype.tasksStdout = function(id, cb) {
      var parseResponseBind;
      parseResponseBind = _.bind(this.parseResponse, this);
      return this.get("projects/" + this.options.project_id + "/tasks/" + id + "/outlog", {}, function(error, response, body) {
        return parseResponseBind(error, response, body, cb, false);
      });
    };
    ...
    APIClient.prototype.clustersList = function(options, cb) {
      var parseResponseBind;
      parseResponseBind = _.bind(this.parseResponse, this);
      return this.get("clusters", options, function(error, response, body) {
        return parseResponseBind(error, response, body, cb);
      });
    };

    APIClient.prototype.clustersGet = function(id, cb) {
      var parseResponseBind;
      parseResponseBind = _.bind(this.parseResponse, this);
      return this.get("clusters/" + id, {}, function(error, response, body) {
        return parseResponseBind(error, response, body, cb);
      });
    };

    APIClient.prototype.clustersStats = function(id, cb) {
      var parseResponseBind;
      parseResponseBind = _.bind(this.parseResponse, this);
      return this.get("clusters/" + id + "/stats", {}, function(error, response, body) {
        return parseResponseBind(error, response, body, cb);
      });
    };

    APIClient.prototype.clustersCreate = function(clusterName, memory, disk, options, cb) {
      var parseResponseBind;
      parseResponseBind = _.bind(this.parseResponse, this);
      return this.post("clusters", _.extend({
        'name': clusterName,
        'memory': memory,
        'disk': disk
    ...
    APIClient.prototype.clustersUpdate = function(id, options, cb) {
      var parseResponseBind;
      parseResponseBind = _.bind(this.parseResponse, this);
      return this.put("clusters/" + id, options, function(error, response, body) {
        return parseResponseBind(error, response, body, cb);
      });
    };

    APIClient.prototype.clustersDelete = function(id, cb) {
      var parseResponseBind;
      parseResponseBind = _.bind(this.parseResponse, this);
      return this["delete"]("clusters/" + id, {}, function(error, response, body) {
        return parseResponseBind(error, response, body, cb);
      });
    };

    APIClient.prototype.instanceTerminate = function(id, instance_id, cb) {
      var parseResponseBind;
      parseResponseBind = _.bind(this.parseResponse, this);
      return this.post("clusters/" + id + "/terminate", {
